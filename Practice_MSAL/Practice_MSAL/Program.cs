...
using Practice_MSAL.RepositoryServices;
...
//Key Vault
var keyVaultEndpoint = new Uri($"https://{builder.Configuration["DbObject"]}.vault.azure.net/");
builder.Configuration.AddAzureKeyVault(keyVaultEndpoint, new DefaultAzureCredential());

builder.Services.AddDbContext<DbClass>(x => x.UseSqlServer(builder.Configuration["vinayConnstring"]));
builder.Services.AddScoped<IDataRepository<Msal_Class>, MsalServices>();
